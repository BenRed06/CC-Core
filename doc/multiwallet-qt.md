...
In order to support loading of multiple wallets in crystalcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is crystalcoin.cpp.
...
Changes to crystalcoin.cpp
----------------------
crystalcoin.cpp is the entry point into crystalcoin-qt, and as such, will require some minor modifications to provide hooks for
