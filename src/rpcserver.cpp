...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* crystalcoin features */
        {"crystalcoin", "masternode", &masternode, true, true, false},
        {"crystalcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"crystalcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"crystalcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"crystalcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"crystalcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"crystalcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"crystalcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"crystalcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"crystalcoin", "startmasternode", &startmasternode, true, true, false},
        {"crystalcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"crystalcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"crystalcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"crystalcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"crystalcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"crystalcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"crystalcoin", "mnbudget", &mnbudget, true, true, false},
        {"crystalcoin", "preparebudget", &preparebudget, true, true, false},
        {"crystalcoin", "submitbudget", &submitbudget, true, true, false},
        {"crystalcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"crystalcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"crystalcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"crystalcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"crystalcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"crystalcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"crystalcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"crystalcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"crystalcoin", "mnsync", &mnsync, true, true, false},
        {"crystalcoin", "spork", &spork, true, true, false},
        {"crystalcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> crystalcoin-cli " + methodname + " " + args + "\n";
}
