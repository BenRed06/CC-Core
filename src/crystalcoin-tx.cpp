...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("crystalcoin crystalcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  crystalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crystalcoin transaction") + "\n" +
                               "  crystalcoin-tx [options] -create [commands]   " + _("Create hex-encoded crystalcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded crystalcoin transaction
