...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "crystalcoin is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1613775216;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 4388365;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xbd19f2f83ca02dcda5681e6ab414af6c62fdabd3d9602bdab4549b5a94d00e95"));
        assert(hashGenesisBlock == uint256("0x0000052a6f7c84b3e44a9f1405d8dba25a296c5b57772dbcb1e38c2cc055be60"));

     
		
	vSeeds.push_back(CDNSSeedData("1", "45.77.104.233"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xbd19f2f83ca02dcda5681e6ab414af6c62fdabd3d9602bdab4549b5a94d00e95"));
        assert(hashGenesisBlock == uint256("0x00004acd790d9170df0aacacf0cc42783bed8a22748d97e9583a781809254626"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xbd19f2f83ca02dcda5681e6ab414af6c62fdabd3d9602bdab4549b5a94d00e95"));
        assert(hashGenesisBlock == uint256("0x6f83eb49c8702a883f383f788797da67becb9adc79d1179db920e50d28fa330e"));
