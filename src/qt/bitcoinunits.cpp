...
QString BitcoinUnits::id(int unit)
{
    ...
    case crystalcoin:
        return QString("CRY");
    case mECA:
        return QString("mcrystalcoin");
    case uECA:
        return QString::fromUtf8("ucrystalcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case crystalcoin:
            return QString("tCRY");
        case mECA:
            return QString("mtCRY");
        case uECA:
            return QString::fromUtf8("μtCRY");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case crystalcoin:
            return QString("CRY");
        case mECA:
            return QString("Milli-crystalcoin (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-crystalcoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
