...
/* crystalcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "crystalcoin"
#define QAPP_ORG_DOMAIN "crystalcoinproject.org"
#define QAPP_APP_NAME_DEFAULT "crystalcoin-Qt"
#define QAPP_APP_NAME_TESTNET "crystalcoin-Qt-testnet"
