...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("crystalcoin Core"),
     ...
     * override -datadir in the crystalcoin.conf file in the default data directory
     * (to be consistent with crystalcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
