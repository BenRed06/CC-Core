                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CrystalCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&crystalcoin Project"), this);
    webmainAction->setStatusTip(tr("crystalcoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("crystalcoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("crystalcoin Twitter"));
    ...
    discordAction->setStatusTip(tr("crystalcoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("crystalcoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("crystalcoin Telegram"));
    ...
    redditAction->setStatusTip(tr("crystalcoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap crystalcoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell crystalcoin Coin (crystalcoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    crystalcoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&crystalcoin block explorer"), this);
    crystalcoinBlockExplorerAction->setStatusTip(tr("crystalcoin blockchain explorer"));
    crystalcoinBlockExplorerAction->setToolTip(crystalcoinBlockExplorerAction->statusTip());
    crystalcoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&crystalcoin Project Github"), this);
    githubAction->setStatusTip(tr("crystalcoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a crystalcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crystalcoin: URIs)"));
...
//    }
    ...
    connect(crystalcoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(crystalcoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About crystalcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about crystalcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for crystalcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your crystalcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified crystalcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a crystalcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the crystalcoin Core help message to get a list with possible crystalcoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(crystalcoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("crystalcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.crystalcoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/crystalcoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/crystalcoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/crystalcoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/crystalcoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::crystalcoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/crystalcoin/crystalcoin/"));
}
...
{
    QString strTitle = tr("crystalcoin Core"); // default title
