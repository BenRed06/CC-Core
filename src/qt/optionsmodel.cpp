...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::crystalcoin);
    ...
    if (!settings.contains("nAnonymizecrystalcoinAmount"))
        settings.setValue("nAnonymizecrystalcoinAmount", 1000);

    nAnonymizecrystalcoinAmount = settings.value("nAnonymizecrystalcoinAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizecrystalcoinAmount"))
        SoftSetArg("-anonymizecrystalcoinamount", settings.value("nAnonymizecrystalcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in crystalcoin.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizecrystalcoinAmount:
            return QVariant(nAnonymizecrystalcoinAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizecrystalcoinAmount:
            nAnonymizecrystalcoinAmount = value.toInt();
            settings.setValue("nAnonymizecrystalcoinAmount", nAnonymizecrystalcoinAmount);
            emit anonymizecrystalcoinAmountChanged(nAnonymizecrystalcoinAmount);
            break;
        case CoinControlFeatures:
