Contributing to crystalcoin Core
============================

The crystalcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the crystalcoin Core project, and is not to be
confused with overall crystalcoin Network Protocol consensus changes.

Whether a pull request is merged into crystalcoin Core rests with the project merge
...
Patches that change crystalcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the crystalcoin consensus, it must have been
...
The project leader is the release manager for each crystalcoin Core release.
